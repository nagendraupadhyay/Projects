...
//The function below constructs a new doublevector.
doublevector()
{
	mValues = nullptr;
}

//The function below destructs the data stored in double vector.
~doublevector()
{
	if(mValues != nullptr)
	{
...
//The function below increases the size of the vector by 1.
void push_back(double value)
{
	resize(mNumValues + 1, value);
}

//The function below returns a reference to the value at the given index. 
double &at(int index)
{
	if (index >= mNumValues) 
	{
...
//This function will return a reference to the value at the given index.
const double &at(int index) const
{
	if (index >= mNumValues)
	{
...
//The function will typecast your mNumValues into an unsigned long and return it.
unsigned long size() const
{
	return mNumvalues;
}

//This function resizes the doublevector to the given new_size.
